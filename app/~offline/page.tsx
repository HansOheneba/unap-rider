export default function OfflinePage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-100 px-6 text-center">
      <p className="section-label">You are offline</p>
      <h1 className="mt-2">No connection right now</h1>
      <p className="mt-3 max-w-sm text-zinc-600">
        Check your mobile data or Wi-Fi, then reopen U Rider. Your signed-in
