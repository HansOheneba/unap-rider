...
const buttonVariants = cva(
  "inline-flex min-h-11 items-center justify-center gap-2 whitespace-nowrap rounded-xl transition-colors disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        link: "min-h-0 text-zinc-900 underline-offset-4 hover:underline",
      ...
      size: {
        ...
        sm: "h-10 min-h-10 rounded-lg px-3 text-[length:var(--text-caption)]",
